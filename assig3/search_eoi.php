...
<h1>Search for Records by EOI Number</h1>

	<form 	method="post"	action="search_eoi.php" >
	<fieldset><legend>Search Records by EOI Number:</legend>

		<p class="row">	<label for="searchforeoi">EOI Number: </label>
			<input type="text"	 name="searchforeoi" 	maxlength ="5"	id="searchforeoi"	 placeholder="Search..."/></p>
		</fieldset>
